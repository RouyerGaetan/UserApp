    ...
    public partial class NewDB : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NotesAthletes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_NotesAthletes_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_NotesAthletes_Athletes_AthleteId",
                        column: x => x.AthleteId,
                        principalTable: "Athletes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_NotesAthletes_Evenements_EvenementId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NotesEvenements", x => x.Id);
                    table.ForeignKey(
                        name: "FK_NotesEvenements_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NotesAthletes_AthleteId",
                table: "NotesAthletes",
                column: "AthleteId");

            migrationBuilder.CreateIndex(
                name: "IX_NotesAthletes_EvenementId",
                table: "NotesAthletes",
                column: "EvenementId");

            migrationBuilder.CreateIndex(
                name: "IX_NotesAthletes_UserId",
                table: "NotesAthletes",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_NotesEvenements_EvenementId",
                table: "NotesEvenements",
                column: "EvenementId");

            migrationBuilder.CreateIndex(
                name: "IX_NotesEvenements_UserId",
                table: "NotesEvenements",
                column: "UserId");
